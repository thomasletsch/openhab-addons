...
public class BiSecureGatewayHandlerFactory extends BaseThingHandlerFactory {
    ...
    private static final List<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Arrays.asList(GATEWAY_BRIDGE_TYPE,
            GROUP_THING_TYPE, PORT_THING_TYPE);
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (GATEWAY_BRIDGE_TYPE.equals(thingTypeUID)) {
            return new BiSecureGatewayHandler(thing);
        }
